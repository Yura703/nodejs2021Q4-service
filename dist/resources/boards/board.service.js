...
var board_memory_repository_1 = __importDefault(require("./board.memory.repository"));
 ...
 */
var findById = function (id) { return board_memory_repository_1.default.findById(id); };
/**
 *  Get all objects Board from Repository
 *  @returns all objects Board from Repository
 */
var findAll = function () { return board_memory_repository_1.default.findAll(); };
/**
 ...
 */
var createBoard = function (board) { return board_memory_repository_1.default.createBoard(board); };
/**
 ...
 */
var editBoard = function (id, board) { return board_memory_repository_1.default.editBoard(id, board); };
/**
...
module.exports = { findById: findById, findAll: findAll, createBoard: createBoard, editBoard: editBoard, deleteBoard: deleteBoard };
